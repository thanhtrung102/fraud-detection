...
def save_results(metrics: dict, comparison: dict, output_dir: str = "results"):
    ...
    results = {"metrics": metrics, "comparison_with_paper": comparison}
...
def generate_all_plots(
    y_true: np.ndarray, y_pred: np.ndarray, y_proba: np.ndarray, output_dir: str = "results"
):
    ...
    plot_roc_curve(y_true, y_proba, str(output_dir / "roc_curve.png"))
    plot_precision_recall_curve(y_true, y_proba, str(output_dir / "precision_recall_curve.png"))
